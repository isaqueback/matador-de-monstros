new Vue({
  ...
  data: {
    ...
    apareceEmpate: false,
    apareceLogs: false,
    menorQ20Jogador: false,
    menorQ20Monstro: false,
    danos: [],
  },
  computed: {
  ...
  methods: {
    iniciar() {
      ...
      this.menorQ20Jogador = false;
      this.menorQ20Monstro = false;
    },
    desistir() {
      this.vidaJogador = 100;
      this.vidaMonstro = 100;
    ...
    atacar() {
      ...
      if (barraJogadorFuturo < 0 && barraMonstroFuturo < 0) {
        ...
        this.menorQ20Jogador = true;
        this.menorQ20Monstro = true;
        this.apareceAcoes = false;
